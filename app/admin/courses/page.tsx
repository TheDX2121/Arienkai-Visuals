    ...
    <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        ...
        <p className="mt-3 text-white/55">
          Courses created here appear on the public Courses page.
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        >
          ...
          <label className="mb-2 mt-5 block text-sm font-bold">Course title</label>
          <input className="input" name="title" placeholder="Thumbnail Design Mastery" required />

          <label className="mb-2 mt-5 block text-sm font-bold">Description</label>
          <textarea className="input min-h-28" name="description" placeholder="Course description..." required />

          <label className="mb-2 mt-5 block text-sm font-bold">Level</label>
          ...
          <label className="mb-2 mt-5 block text-sm font-bold">Number of lessons</label>
              ...
              return (
                <article key={course.id} className="glass-panel rounded-[2rem] p-6">
                  <div className="flex flex-wrap items-start justify-between gap-4">
                    <div>
                      ...
                      <div className="mt-3 flex flex-wrap gap-2 text-xs text-white/45">
                        ...
                        {course.isPremium ? (
                          <span className="pill bg-gold/20 text-yellow-100">Premium</span>
                        ) : (
                  ...
                  <details className="mt-4 rounded-2xl bg-white/5 p-4">
                    <summary className="cursor-pointer font-black">Lessons</summary>
                    ...
                    <div className="mt-5 grid gap-2">
                      {courseLessons.length ? (
                        ...
                        <p className="text-sm text-white/45">No lessons added yet.</p>
                      )}
                    </div>
                  </details>

                  <form action={`/api/admin/courses/${course.id}/delete`} method="post" className="mt-4">
                    <button className="rounded-full border border-red-500/40 bg-red-500/10 px-4 py-2 text-sm font-bold text-red-100" type="submit">
                      Delete course
                    </button>
                  </form>
                </article>
