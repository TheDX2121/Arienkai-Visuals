  ...
  const sections = [
    {
      title: "Home",
      href: "/admin/home",
      description: "Edit homepage slider, sections, pinned offers, and cards."
    },
    {
      title: "Courses",
      href: "/admin/courses",
  ...
  const sections = [
    {
      ...
      href: "/admin/home",
      description:
        "Edit homepage slider, pinned offers, sections, and cards."
    },
    {
      title: "Courses",
      href: "/admin/courses",
    ...
    },
    {
      ...
      href: "/admin/materials",
      description:
        "Manage downloadable creator materials."
    },
    {
      title: "Categories",
      href: "/admin/categories",
      description:
        "Manage course and material categories."
    },
    {
      title: "News",
      href: "/admin/news",
    ...
    },
    {
      ...
      href: "/admin/users",
      description:
        "Manage users, roles, premium plans, and moderation."
    },
    {
      title: "Navbar",
      href: "/admin/navbar",
      description:
        "Edit logo, navigation links, and buttons."
    },
    {
      title: "Footer",
      href: "/admin/footer",
      description:
        "Edit footer logo, text, and links."
    }
  ];
