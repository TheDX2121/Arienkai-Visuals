    ...
    <section className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-6xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:px-8">
      <div>
        ...
        <h1 className="text-5xl font-black tracking-tight">
          Enter your creator studio.
        </h1>

        <p className="mt-4 max-w-xl text-white/58">
          Sign in to follow artists, save GFX packs, rate previews, continue
          courses, and upload your latest anime artwork.
        </p>
      </div>

      <form action={formAction} method="post" className="glass-panel rounded-[2rem] p-6">
        {errorMessage ? (
        ...
        <input
          className="input"
          name="identifier"
          placeholder="admin@arienkai.visuals"
          required
        />
